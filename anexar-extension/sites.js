var defaultSites = {
  ...
  "Arena Holdings (ZA; opt-in to custom sites for unlisted)": {
    domain: "###_za_arena",
    group: [
      "businessday.co.za",
      "timeslive.co.za"
    ...
    allow_cookies: 1,
    block_regex: /\.arc-cdn\.net\/arc\/subs\/p\.min\.js/
  },
  "Artforum": {
    domain: "artforum.com"
  },
  ...
  "Automobilwoche": {
    ...
    allow_cookies: 1,
    block_regex: /(\.automobilwoche\.de\/script\.js|js\.pelcro\.com\/|\.sophi\.io\/)/
  },
  "AutoPlus.fr": {
    domain: "autoplus.fr",
    allow_cookies: 1,
  ...
  "Berliner Zeitung (fetch from archive.is)": {
    domain: "berliner-zeitung.de",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  "Berlingske Media": {
    domain: "###_dk_berlingske_media",
    group: [
      "berlingske.dk",
      "weekendavisen.dk"
    ],
  ...
  "Bloomberg (not Terminal)": {
    domain: "bloomberg.com",
    allow_cookies: 1,
    block_regex: /\.bwbx\.io\/s3\/fence\/fortress-client\//,
    cs_dompurify: 1
  },
  "Bloomberg Adria": {
  ...
  "Business Standard": {
    ...
    remove_cookies_select_drop: ["userUid"],
    cs_dompurify: 1
  },
  ...
  "CaravanMagazine.in (fetch from archive.is)": {
  ...
  "Chunichi Shimbun Group": {
    domain: "###_jp_chunichi_shimbun",
    group: [
      "chunichi.co.jp",
      "tokyo-np.co.jp"
    ],
    ...
    exception: [{
        ...
        allow_cookies: 1,
        block_regex: /\.tokyo-np\.co\.jp\/tokyo-np\/js\/comment\/comment_scroll_list\.js/,
        useragent: "googlebot"
      }
    ]
  },
  "Cicero.de (fetch from archive.is)": {
    domain: "cicero.de",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  "Citeline Insights": {
    domain: "insights.citeline.com",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  "Citywire": {
  ...
  "Condé Nast magazines": {
    ...
    exception: [{
        ...
        remove_cookies_select_drop: ["pay_ent_msmp"]
      }
    ]
  },
  ...
  "Corriere della Sera": {
    domain: "corriere.it",
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\.ith9ueyuhu\.it\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/
  },
  ...
  "Cox First Media (opt-in to custom sites for unlisted)": {
    domain: "###_usa_cox_first_media",
    group: [
      "daytondailynews.com"
    ],
    allow_cookies: 1,
    block_regex: /\.coxohio\.com\/prod\/ajc\/loader\.min\.js/
  },
  "Crain Communications": {
    ...
    allow_cookies: 1,
    block_regex: "(js\\.pelcro\\.com\\/|\\.sophi\\.io\\/|\\.{domain}\\/script\\.js)",
    cs_dompurify: 1,
    exception: [{
        domain: ["360dx.com", "genomeweb.com", "precisionmedicineonline.com"],
        allow_cookies: 1,
        block_regex: "(js\\.pelcro\\.com\\/|\\.{domain}\\/(script|profiles\\/.+\\/crain_pelcro_user)\\.js)"
      }, {
  ...
  "Deutscher Fachverlag Mediengruppe (opt-in to custom sites)": {
    ...
    allow_cookies: 1,
    useragent: "googlebot",
    add_ext_link: ".FormRegisterNG:is(div,section)|div.PageArticle",
    add_ext_link_type: "google_search_tool",
    cs_code: [{"hide_elem":"div.Ad"}]
  },
  ...
  "El Espectador": {
    ...
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\.cxense\.com\/|js\.matheranalytics\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/
  },
  "El Mercurio (digital only)": {
    domain: "elmercurio.com",
    allow_cookies: 1,
    block_regex: /\.(elmercurio\.com|emol\.cl)\/(.+\/)?js\/(.+\/)?(modal|merPramV\d|(FuncionesComun|PramModal)\.min)\.js/,
    useragent: "googlebot"
  },
  ...
  "El País": {
    ...
    block_regex: /(\.prisa\.com\/dist\/subs\/pmwall\/.+\/pmwall\.min\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/
  },
  "El País.com.uy": {
  ...
  "Erna Media.se (opt-in to custom sites)": {
    domain: "###_se_erna_media",
    group: [],
    allow_cookies: 1,
    useragent: "googlebot"
  },
  ...
  "Exame": {
    domain: "exame.com",
    allow_cookies: 1,
    block_regex: /\/exame\.com\/_next\/static\/chunks\/app\/%5B.+\.js/
  },
  ...
  "First Things": {
    ...
    allow_cookies: 1,
    block_regex: /\/firstthings\.com\/wp-content\/plugins\/leaky-paywall\/js\/leaky-paywall-cookie\.js/
  },
  "FMR": {
    domain: "fmrmagazine.com",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  "FocusPlus.de": {
  ...
  "Fortune": {
    domain: "fortune.com",
    allow_cookies: 1,
    block_regex: /\.fortune\.com\/api\/tinypass\.min\.js/
  },
  ...
  "Groupe La Manche Libre": {
    domain: "###_fr_groupe_la_manche_libre",
    group: [
      "lamanchelibre.fr"
    ],
    allow_cookies: 1,
  ...
  "Groupe Télégramme": {
    ...
    allow_cookies: 1,
    block_regex: /\.poool\.fr\//,
    cs_code: [{"hide_elem": "div[id^='advertising-']"}]
  },
  "Grupo Abril": {
    domain: "abril.com.br",
    allow_cookies: 1,
  ...
  "Grupo Vocento": {
    ...
    allow_cookies: 1,
    block_regex: /(\.evolok\.net\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/
  },
  "Gruppo GEDI.it": {
    domain: "###_it_gedi",
    group: [
  ...
  "Haaretz Group (article no menu/footer)": {
  ...
  "Harper's Magazine (free articles only)": {
    domain: "harpers.org",
  ...
  "Haymarket Medical Network (opt-in to custom sites)": {
    ...
    allow_cookies: 1,
    remove_cookies: 1,
    cs_code: [{"hide_elem":"div#modal-register-popup, div.gating-banner"}, {"cond":"div[data-gated]", "rm_attrib":"data-gated"}]
  },
  ...
  "Hola": {
    domain: "hola.com",
    allow_cookies: 1,
    block_regex: /(\.hola\.com\/evolok\/ev-em\.min\.js|\.poool\.fr\/)/,
    cs_code: [{"hide_elem":"div[data-ad-title]"}]
  },
  ...
  "Iconic Media Group (UK; opt-in to custom sites for unlisted)": {
    domain: "###_uk_iconic_media",
    group: [
      "scotsman.com",
      "yorkshirepost.co.uk"
    ],
  ...
  "Il Foglio": {
    domain: "ilfoglio.it",
    allow_cookies: 1,
    block_regex: /\.newsmemory\.com\/\?meter/
  },
  "Il Manifesto": {
  ...
  "Institute of Art and Ideas (articles only)": {
    domain: "iai.tv",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  ...
  "Investor's Business Daily": {
    ...
    remove_cookies_select_drop: ["__tbc"],
    block_regex: /\.tinypass\.com\//,
    cs_dompurify: 1
  },
  ...
  "L'Équipe.fr": {
    domain: "lequipe.fr",
    allow_cookies: 1,
    block_regex: /(\.poool\.fr\/|\.lequipe\.fr\/assets\/js\/.*[wW]all.+\.js)/,
    cs_dompurify: 1
  },
  "L'Express": {
    domain: "lexpress.fr",
  ...
  "L'Humanité": {
    domain: "humanite.fr",
    allow_cookies: 1,
    block_regex: /(\.poool\.fr\/|\.qiota\.com\/)/,
    cs_dompurify: 1
  },
  "L'Informé (not pro)": {
    domain: "linforme.com",
  ...
  "La Nación": {
    ...
    allow_cookies: 1,
    block_regex: /\.glanacion\.com\/.+\/metering\/.+\.js/,
    cs_dompurify: 1
  },
  "La Segunda (not digital)": {
    domain: "lasegunda.com",
    allow_cookies: 1,
    block_regex: /\.emol\.cl\/(.+\/)?(pram-modal|PramModal)\.min\.js/,
    cs_dompurify: 1
  },
  "La Tercera": {
  ...
  "Le Temps.ch (fetch from archive.is)": {
    domain: "letemps.ch",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  ...
  "Loeb Classical Library": {
    ...
    remove_cookies_select_drop: ["hupLclFreeReadsCookie"]
  },
  ...
  "Los Angeles Times": {
    domain: "latimes.com",
    allow_cookies: 1,
    block_regex: /(\.latimes\.com\/meteringjs|\.californiatimes\.com\/caltimes\/latimes\/Bootstrap\.js)/
  },
  ...
  "MarketWatch": {
    ...
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\.cxense\.com\/)/,
  ...
  "Mediahuis Noord (+ regional/opt-in to custom sites)": {
    ...
    allow_cookies: 1,
    block_regex: /\.ndcmediagroep\.nl\/js\/evolok\//,
    cs_dompurify: 1
  },
  ...
  "Mexico News Daily": {
    ...
    allow_cookies: 1,
    block_regex: /\/mexiconewsdaily\.com\/wp-json\/leaky-paywall\/v1\/check-restrictions/
  },
  "Mid-Day (not epaper)": {
    domain: "mid-day.com",
    allow_cookies: 1,
  ...
  "Mittelbayerische Zeitung (fetch from archive.is)": {
  ...
  "MusicOMH": {
    domain: "musicomh.com",
    allow_cookies: 1,
    block_regex: /(\.axate\.io\/|\.musicomh\.com\/wp-content\/.+\/bundle\.js)/
  },
  ...
  "National Geographic ES": {
    ...
    allow_cookies: 1,
    block_regex: /\.nationalgeographic\.com\.es\/Content\/js\/lib\/runtime\.min\.js/
  },
  "National Geographic IT": {
    domain: "nationalgeographic.it",
    allow_cookies: 1
  },
  "National Geographic NL": {
    domain: "nationalgeographic.nl",
    allow_cookies: 1,
    block_regex: /\.piano\.io\//
  },
  ...
  "Observador.pt": {
    ...
    allow_cookies: 1,
    block_regex: /\/observador\.pt\/wp-content\/.+\/paywall-price-.+\.js/
  },
  "ON3 (fetch from archive.is)": {
    domain: "on3.com",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  ...
  "Passauer Neue Presse (fetch from archive.is)": {
    domain: "pnp.de",
    allow_cookies: 1,
    block_regex: /\.piano\.io\//,
    cs_dompurify: 1
  ...
  "Roularta Media Group": {
    ...
    allow_cookies: 1,
    block_regex: "[\\.\\/]{domain}\\/(script|.+\\/rmg-paywall)\\.js",
    useragent: "googlebot"
  },
  "RugbyPass": {
  ...
  "Sound Publishing (opt-in to custom sites)": {
    domain: "###_usa_sound_publishing",
    allow_cookies: 1,
    block_regex: /(\.com\/script\.js|\/wp-content\/plugins\/incognito_dectector\/)/
  },
  ...
  "Southern Weekly (fetch from archive.is)": {
    domain: "infzm.com",
    allow_cookies: 1,
    cs_dompurify: 1
  },
  ...
  "SPH Media (SG)": {
    ...
    exception: [{
        ...
        allow_cookies: 1,
        block_js_inline: /\.straitstimes\.com\/(opinion\/|.+(\w+-){3,}.+\?rel=plus)/,
        cs_dompurify: 1
      }
    ]
  },
  ...
  "StatNews (fetch from archive.is)": {
    domain: "statnews.com",
    allow_cookies: 1,
    block_regex: /\.tinypass\.com\//,
    cs_dompurify: 1
  },
  "Stereogum (no comments)": {
    domain: "stereogum.com",
    allow_cookies: 1,
    block_regex: /\/stereogum\.com\/_next\/static\/chunks\/pages\/_sites\/%5BsiteSlug%5D\/%5B\.\.\.slug.+\.js/
  },
  ...
  "Südwest Media Network (opt-in to custom sites for unlisted)": {
    domain: "###_de_smn",
    group: [
    ...
    allow_cookies: 1,
    block_regex: /\.de\/xbuilder\/experience\/execute/,
    exception: [{
        domain: ["cannstatter-zeitung.de", "esslinger-zeitung.de", "frankenpost.de", "insuedthueringen.de", "krzbb.de", "kurier.de", "np-coburg.de"],
        allow_cookies: 1,
        cs_dompurify: 1
      }
    ]
  ...
  "Tamedia.ch Group (opt-in to custom sites for unlisted)": {
    ...
    remove_cookies_select_drop: ["entitlementToken", "tmc"],
    block_regex: /\.tinypass\.com\//,
    useragent: "googlebot"
  },
  "Tampa Bay Times": {
  ...
  "Telegraaf (fetch from archive.is)": {
    domain: "telegraaf.nl",
  ...
  "The Business Journals (free articles only)": {
    ...
    allow_cookies: 1,
    block_regex: /\.cxense\.com\//,
    block_js_inline: /\.bizjournals\.com\/.+\/(news|stories)\/.+\.html\?rel=plus/,
    cs_dompurify: 1
  },
  ...
  "The Dispatch (free articles only; do not block TinyPass-script externally)": {
  ...
  "The Economic Times (ET Prime)": {
    ...
    allow_cookies: 1,
    block_regex: /apw\.economictimes\.indiatimes\.com\//,
    useragent: "googlebot",
    exception: [{
  ...
  "The Globe and Mail": {
    ...
    allow_cookies: 1,
    block_regex: /(\.sophi\.io\/|\.theglobeandmail\.com\/zephr\/feature)/
  },
  "The Hill": {
    domain: "thehill.com",
    allow_cookies: 1,
  ...
  "The Hindu (not epaper)": {
    domain: "thehindu.com",
    allow_cookies: 1,
    block_regex: /(\.cxense\.com\/|\.piano\.io\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/
  },
  ...
  "The Information (news only; fetch from archive.is)": {
  ...
  "The Market.ch": {
    domain: "themarket.ch",
    allow_cookies: 1,
    block_regex: /(\.piano\.io\/|tms\.danzz\.ch\/scripts\/t\.min\.js)/
  },
  "The Nation": {
    domain: "thenation.com",
    allow_cookies: 1,
    block_regex: /(\.thenation\.com\/wp-content\/themes\/.+\/js\/paywall\/main\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/
  },
  "The New Atlantis": {
  ...
  "The New York Times": {
    ...
    useragent_custom: "Mozilla/5.0 (compatible; Google-InspectionTool/1.0)"
  },
  "The News Lens (JP)": {
  ...
  "The San Francisco Standard": {
    ...
    remove_cookies_select_drop: ["zephr-session"],
    cs_clear_lclstrg: 1,
    block_regex: /\/sfstandard\.com\/api\/content\/decision/
  },
  "The Saturday Paper": {
  ...
  "The Spokesman-Review": {
    ...
    allow_cookies: 1,
    block_regex: /\.wgchrrammzv\.com\/prod\/spokesman\/loader\.min\.js/
  },
  "The Stage Media (UK)": {
  ...
  "The Times UK (fetch from archive.is)": {
    domain: "thetimes.com",
    allow_cookies: 1,
    block_regex: /(\.zephr\.com\/zephr-browser\/|\.thetimes\.com\/wp-content\/plugins\/tm-wp-zephr\/)/,
    cs_dompurify: 1
  },
  ...
  "The Toronto Star (+ local TorStar sites)": {
    ...
    allow_cookies: 1,
    block_regex: "\\.{domain}\\/.+\\/tncms\\/api\\/access\\..+\\.js",
    cs_dompurify: 1
  },
  ...
  "Tribune Publishing Company": {
    ...
    allow_cookies: 1,
    block_regex: "(\\.{domain}\\/(script|.+\\/loader-wp\\/static\\/loader\\.min)\\.js|\\.sophi\\.io\\/)",
    cs_dompurify: 1
  },
  "Tuttosport": {
  ...
  "UOL.com.br": {
    domain: "uol.com.br",
    allow_cookies: 1,
    block_regex: /(paywall\.folha\.uol\.com\.br\/|\.(tinypass|matheranalytics)\.com\/|\.poool\.fr\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
    useragent: "googlebot"
  },
  "USA Today": {
    domain: "usatoday.com",
  ...
  "Verlagsgruppe Rhein Main (fetch from archive.is; opt-in to custom sites for unlisted)": {
    domain: "###_de_vrm",
    group: [
  ...
  "WirtschaftsWoche (text only & GST-link)": {
    domain: "wiwo.de",
    allow_cookies: 1
  },
  "Wonderzine": {
  ...
  "Ynet": {
    domain: "ynet.co.il",
    allow_cookies: 1,
    block_js_inline: /\.ynet\.co\.il\/.+\/article\/.+\?rel=plus/
  },
  ...
  "Leaky Paywall (WordPress plugin)": {
    ...
    group: [],
    block_regex_general: /\/(wp-content\/plugins\/leaky-paywall\/js\/leaky-paywall-cookie\.js|wp-json\/leaky-paywall\/v\d\/check-restrictions)/
  },
  "MatherAnalytics": {
  ...
  "Memberstack": {
    ...
    group: [],
    allow_cookies: 1,
    block_regex_general: /\.memberstack\.com\/scripts\/.+\/memberstack\.js/,
    excluded_domains: ["memberstack.com"]
  },
  ...
  "Piano.io (+ TinyPass)": {
    ...
    excluded_domains: ["piano.io", "automobilwoche.de", "frontline.thehindu.com", "hbr.org", "japantimes.co.jp", "nacion.com", "thedispatch.com"]
  },
  "Pico.tools": {
    domain: "pico.tools",
    allow_cookies: 1,
  ...
  "Pmpro Limit Post Views (WordPress plugin)": {
    domain: "###_wp_pmpro_limit_post_views",
    allow_cookies: 1,
    block_regex_general: /\/wp-content\/plugins\/pmpro-limit-post-views\/js\/pmprolpv\.js/
  },
  "Poool.fr": {
    domain: "poool.fr",
    allow_cookies: 1,
  ...
  "Wallkit (WordPress plugin)": {
    domain: "###_wp_wallkit",
    group: [],
    allow_cookies: 1,
    block_regex_general: /\.wallkit\.net\/js\//
  },
  "Zephr": {
    domain: "zephr.com",
    allow_cookies: 1,
...
if (ext_chromium) {
  ...
  var nyp_title = 'New York Post';
  defaultSites[nyp_title] = {
    domain: "nypost.com",
    group: [
      "nypost.com",
    ...
    block_regex: /\.nypost\.com\/zephr\/feature/,
    exception: [{
        domain: "nypost.djservices.io",
        allow_cookies: 1,
        headers_custom: defaultSites[nyp_title]['cs_param']
      }
    ]
  };
}
...
var custom_flex_not = {
  ...
  "###_wp_leaky_paywall": ["koreapro.org", "nknews.org", "theregistrysf.com", "uppereastsite.com"],
...
var ch_media_nofix_domains = ['aargauerzeitung.ch', 'luzernerzeitung.ch', 'tagblatt.ch'];
...
var uk_ft_specialist_nofix = ['agendanews.com', 'boardiq.com', 'financialadvisoriq.com', 'fundfire.com', 'healthpayerspecialist.com', 'ignites.com', 'ignitesasia.com', 'igniteseurope.com', 'lifeannuityspecialist.com', 'pandcspecialist.com'];
var usa_allcity_network_nofix_domains = ['allchgo.com', 'alldlls.com', 'allphly.com', 'gophnx.com', 'thednvr.com'];
var nofix_sites = ['11freunde.de', '24.hu', '444.hu', 'abplive.com', 'aerzteblatt.de', 'africa-confidential.com', 'aftonbladet.se', 'agefi.fr', 'allgaeuer-zeitung.de', 'altroconsumo.it', 'americanscientist.org', 'arkansasonline.com', 'arretsurimages.net', 'asahi.com', 'asiatimes.com', 'augsburger-allgemeine.de', 'autocarpro.in', 'aviationweek.com', 'badische-zeitung.de', 'belfasttelegraph.co.uk', 'bisnis.com', 'bloomberglaw.com', 'bloombergtax.com', 'bmj.com', 'bnef.com', 'borsen.dk', 'breakingviews.com', 'breitbart.com', 'brill.com', 'bunshun.jp', 'businessinsider.de', 'businesslive.co.za', 'caixin.com', 'caixinglobal.com', 'cambiocolombia.com', 'capital.de', 'catalyst-journal.com', 'cfnews.net', 'chegg.com', 'cieletespace.fr', 'consumerreports.org', 'cookpolitical.com', 'costar.com', 'coursehero.com', 'crunchbase.com', 'dealstreetasia.com', 'defence24.pl', 'delfi.ee', 'denikn.cz', 'deraktionaer.de', 'deutsche-wirtschafts-nachrichten.de', 'die-glocke.de', 'digitimes.com.tw', 'donaukurier.de', 'dorzeczy.pl', 'e24.no', 'echo24.cz', 'eenews.net', 'eliteprospects.com', 'elnuevodia.com', 'elordenmundial.com', 'epochtimes.se', 'epw.in', 'euractiv.com', 'ewmagazine.nl', 'falter.at', 'finance.si', 'finanz-szene.de', 'forbes.cz', 'gamestar.de', 'gazetaprawna.pl', 'gazeteoksijen.com', 'geo.de', 'geopoliticalfutures.com', 'golem.de', 'gp.se', 'haufe.de', 'hbr-caijing.com', 'hbrarabic.com', 'hbrfrance.fr', 'hedgehogreview.com', 'heraldo.es', 'hindutamil.in', 'histoire-et-civilisations.com', 'history.org.uk', 'hn.cz', 'hpdetijd.nl', 'hsj.co.uk', 'hvg.hu', 'ideas.tikvah.org', 'idnes.cz', 'iex.nl', 'ifre.com', 'independent.ie', 'ilsecoloxix.it', 'iltalehti.fi', 'indiasworld.in', 'indiatimes.com', 'information.dk', 'intelligentinvestor.com.au', 'investing.com', 'jacobin.com', 'janes.com', 'jazziz.com', 'jn.pt', 'jota.info', 'jungefreiheit.de', 'jyllands-posten.dk', 'kicker.de', 'kommunen.dk', 'krone.at', 'lanouvellerepublique.fr', 'laprovence.com', 'latribune.fr', 'laverita.info', 'lavie.fr', 'lavozdegalicia.es', 'law360.ca', 'law360.co.uk', 'law360.com', 'leconomiste.com', 'ledesk.ma', 'lefilmfrancais.com', 'lesjours.fr', 'lexisnexis.co.uk', 'libertiesjournal.com', 'lindipendente.online', 'lloydslist.com', 'lorientlejour.com', 'lr-online.de', 'mailplus.co.uk', 'main-echo.de', 'mainpost.de', 'malaysiakini.com', 'manager-magazin.de', 'mainichi.jp', 'maville.com', 'mediapart.fr', 'micromega.net', 'mlex.com', 'money.it', 'moodys.com', 'mopo.de', 'morningstar.com', 'motorsport.com', 'moz.de', 'mt.de', 'mz.de', 'nachrichten.at', 'natgeo.nikkeibp.co.jp', 'nationaljournal.com', 'nbr.co.nz', 'nd.nl', 'nejm.org', 'newleftreview.org', 'news24.com', 'newsmax.comac', 'newspapers.com', 'newsroom.co.nz', 'nexojornal.com.br', 'nexos.com.mx', 'next.ink', 'ngalarabiya.com', 'nikkansports.com', 'nikkei.com', 'nn.de', 'noen.at', 'note.com', 'nouvelobs.com', 'oantagonista.com.br', 'ojogo.pt', 'onetz.de', 'oup.com', 'pagina12.com.ar', 'penews.com', 'pff.com', 'piratewires.com', 'politicopro.com', 'politiken.dk', 'politis.fr', 'postimees.ee', 'pressreader.com', 'publico.pt', 'quechoisir.org', 'racingpost.com', 'rbc.ru', 'reason.com', 'republic.ru', 'rhein-zeitung.de', 'riffreporter.de', 'rnz.de', 'rtings.com', 'ruhrnachrichten.de', 'sankei.com', 'sciencedirect.com', 'scienceshumaines.com', 'seekingalpha.com', 'slobodnadalmacija.hr', 'sn.at', 'springer.com', 'statista.com', 'stimme.de', 'storm.mg', 'streetinsider.com', 'studocu.com', 'substack.com', 'suedostschweiz.ch', 'svd.se', 'swp.de', 't3n.de', 'table.media', 'tabletmag.com', 'taxation.co.uk', 'taxjournal.com', 'telquel.ma', 'tempo.co', 'test.de', 'the-ken.com', 'the-star.co.ke', 'theinitium.com', 'thejakartapost.com', 'thelancet.com', 'themorningcontext.com', 'theparisreview.org', 'thestar.com.my', 'tipranks.com', 'tradingview.com', 'tribunemag.co.uk', 'tt.com', 'tvn24.pl', 'udn.com', 'valueresearchonline.com', 'van-magazin.de', 'van-magazine.com', 'vedomosti.ru', 'vg.no', 'vi.nl', 'volksstimme.de', 'voguescandinavia.com', 'weltwoche.ch', 'weltwoche.de', 'which.co.uk', 'wissenschaft.de', 'worldpoliticsreview.com', 'woz.ch', 'wpolityce.pl', 'wz.de', 'xakep.ru', 'yomiuri.co.jp', 'zaobao.com.sg', 'zerohedge.com', 'zive.cz', 'zvw.de'].concat(custom_flex_nofix_domains, ch_media_nofix_domains, de_westfalen_medien_nofix_domains, fi_sanoma_nofix_domains, fr_groupe_infopro_nofix_domains, fr_indigo_nofix_domains, fr_jamg_nofix_domains, fr_monde_diplo_nofix_domains, it_gedi_nofix_domains, it_gruppo_nem_nofix_domains, mx_grupo_reforma_nofix_domains, pt_medialivre_nofix_domains, se_bonnier_group_nofix_domains, uk_ft_group_nofix_domains, uk_ft_specialist_nofix, usa_allcity_network_nofix_domains);
